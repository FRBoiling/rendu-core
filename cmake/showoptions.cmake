...
message("* ${RENDU_PROJECT_NAME} Revision             : ${rev_hash} ${rev_date} (${rev_branch} branch)")
if (WINDOWS)
  message("* ${RENDU_PROJECT_NAME} Buildtype            : ${CMAKE_BUILD_TYPE}")
endif ()

message("* ${RENDU_PROJECT_NAME} Project Dir          : ${RENDU_PROJECT_DIR}")
message("* ${RENDU_PROJECT_NAME} Binary Dir           : ${RENDU_PROJECT_OUTDIR}")

# output information about installation-directories and locations
message("* ${RENDU_PROJECT_NAME} Install to           : ${CMAKE_INSTALL_PREFIX}")
if (COPY_CONF)
  if (WINDOWS)
    message("* ${RENDU_PROJECT_NAME} Install configs to   : ${CONF_DIR}")
  else ()
    message("* ${RENDU_PROJECT_NAME} Install configs to   : ${CMAKE_INSTALL_PREFIX}")
  endif ()
endif ()
...
if (RD_BUILD_PROTO)
  message("* Build protobuf           : Yes ")
else ()
  message("* Build protobuf           : No(default)")
endif ()

if (RD_USE_PCH)
  message("* Build core w/PCH       : Yes ")
else ()
  message("* Build core w/PCH       : No (default)")
endif ()

if (RD_WITHOUT_GIT)
  message("* Use GIT revision hash  : No")
  message("")
  message(" *** RD_WITHOUT_GIT - WARNING!")
  message(" *** By choosing the RD_WITHOUT_GIT option you have waived all rights for support,")
...
if (NOT RD_WITH_SOURCE_TREE STREQUAL "no")
  message("* Show source tree       : Yes (${RD_WITH_SOURCE_TREE})")
else ()
...
message("")
message("* Build ${RENDU_PROJECT_NAME} [${RENDU_PROJECT_VERSION}] [C++${CMAKE_CXX_STANDARD}][${CMAKE_BUILD_TYPE}][${CMAKE_CXX_FLAGS}]")
