...
set(RENDU_SAVE_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
set(RENDU_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
set(CMAKE_CXX_FLAGS ${RENDU_SAVE_CMAKE_CXX_FLAGS})
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${RENDU_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
# targets.
add_subdirectory(${rendu_gtest_src_dir} ${rendu_gtest_build_dir} EXCLUDE_FROM_ALL)
