...
if (NOT DEFINED RENDU_IDE_FOLDER)
  set(RENDU_IDE_FOLDER RenduCore)
endif ()
...
function(rendu_cc_test target_name)
  ...
  set_property(TARGET ${_NAME} PROPERTY FOLDER ${RENDU_IDE_FOLDER}/tests)
  if (RENDU_PROPAGATE_CXX_STD)
    # Abseil libraries require C++14 as the current minimum standard.
    # Top-level application CMake projects should ensure a consistent C++
    # standard for all compiled sources by setting CMAKE_CXX_STANDARD.
...
# rendu_cc_executable()
#
# CMake function to imitate Bazel's cc_executable rule.
#
# Parameters:
# NAME: name of target (see Usage below)
# SRCS: List of source files for the binary
...
#
# Note:
# By default, rendu_cc_executable will always create a binary named rendu_${NAME}.
# This will also add it to executable list as rendu_${NAME}.
#
# Usage:
# rendu_cc_library(
#   NAME
...
#     GTest::gtest_main
# )
function(rendu_cc_executable target_name)
  cmake_parse_arguments(RENDU_CC_EXEC
      ""
      "NAME"
      "SRCS;COPTS;DEFINES;LINKOPTS;DEPS"
      ${ARGN}
  ...
  set(_NAME "${target_name}_${RENDU_CC_EXEC_NAME}")
  add_executable(${_NAME} "")
  target_sources(${_NAME} PRIVATE ${RENDU_CC_EXEC_SRCS})
  target_include_directories(${_NAME}
      PUBLIC ${RENDU_COMMON_INCLUDE_DIRS}
  ...
  target_compile_definitions(${_NAME}
      PUBLIC
      ${RENDU_CC_EXEC_DEFINES}
      )
  target_compile_options(${_NAME}
      PRIVATE ${RENDU_CC_EXEC_COPTS}
      )

  target_link_libraries(${_NAME}
      PUBLIC ${RENDU_CC_EXEC_DEPS}
      PRIVATE ${RENDU_CC_EXEC_LINKOPTS}
      )
  # Add all Abseil targets to a folder in the IDE for organization.
  set_property(TARGET ${_NAME} PROPERTY FOLDER ${RENDU_IDE_FOLDER}/rendu)
  ...
  add_executable(${project_name}::${RENDU_CC_EXEC_NAME} ALIAS ${_NAME})
...
function(add_examples_build project_name target_name)
  ExternalProject_Add(${target_name}
      PREFIX ${project_name}
      SOURCE_DIR "${target_name}"
      BINARY_DIR ${target_name}
      STAMP_DIR ${target_name}/logs
      CONFIGURE_COMMAND ""
      BUILD_COMMAND ""
      INSTALL_COMMAND ""
      TEST_COMMAND ""
  ...
  set_property(TARGET ${target_name} PROPERTY FOLDER "target_name")
