...
if(OPENSSL_FOUND)
  ...
  if(NOT OPENSSL_VERSION_OK)
      message(FATAL_ERROR "rendu-core needs OpenSSL version ${OPENSSL_EXPECTED_VERSION} but found too new version ${OPENSSL_VERSION}. rendu-core needs OpenSSL 1.0.x or 1.1.x to work properly. If you still have problems please install OpenSSL 1.0.x if you still have problems search on forum for TCE00022")
  endif()
