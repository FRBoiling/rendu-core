...
# =============================================
# 函数: rendu_add_test
# 描述: 增强版 add_test，自动收集测试源文件、配置测试目标，支持 Catch2 和 GoogleTest
#
# 参数:
#   DIR             - 源码目录（必填）
...
function(rendu_add_test)
    ...
    if (ARG_ALIAS AND ARG_PROJECT)
        ...
        rendu_log_debug("rendu_add_test: ${alias_name} 作为 ALIAS 目标")
    endif ()
    ...
    elseif (ARG_TEST_FRAMEWORK STREQUAL "GTEST")
        # GoogleTest 配置
        # GoogleTest 已经提供了 main 函数
        rendu_log_debug("rendu_add_test: 配置 GoogleTest 测试")
    endif ()
    ...
    rendu_log_info("rendu_add_test: 添加测试 ${target_name}")
    if (ARG_LABELS)
...
function(rendu_add_testsuite)
    ...
    rendu_log_info("rendu_add_testsuite: 添加了 ${test_count} 个测试")
endfunction()
