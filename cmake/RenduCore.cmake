# ====================================================================
# 模块: RenduCore
# 描述: CMake 统一入口模块，按正确顺序加载所有 Rendu CMake 宏和功能
# 依赖模块:
#   - RenduLogging (日志系统，最先加载)
#   - RenduCMakePolicies (策略设置)
#   - RenduConfigureTargets (目标配置)
#   - RenduCheckPlatform (平台检测)
#   - RenduCollectFiles (源文件收集)
#   - RenduCollectDirectories (目录收集)
#   - RenduAddExecutable (可执行文件创建)
#   - RenduAddLibrary (库创建)
#   - RenduAddTest (测试添加)
#   - RenduAddCustomTarget (自定义目标)
#   - RenduAddSubdirectories (子目录添加)
#   - RenduSourceGroup (源码分组)
#   - RenduProject (项目初始化)
#   - RenduPCHSupport (预编译头支持)
#   - ConfigureScripts (脚本配置)
#   - EnsureVersion (版本检查)
#   - RenduExtensions (扩展功能)
#   - RenduPackage (打包功能)
