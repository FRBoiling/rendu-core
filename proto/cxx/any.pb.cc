...
const ::uint32_t
    TableStruct_any_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_any_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_any_2eproto = {
    false,
    false,
    196,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_any_2eproto),
         ::std::false_type{});
