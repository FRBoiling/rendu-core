...
#ifndef GOOGLE_PROTOBUF_INCLUDED_math_2fmath_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_math_2fmath_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_math_2fmath_2eproto;
namespace math {
class vec2;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::math::vec2* Arena::CreateMaybeMessage<::math::vec2>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace math {
...
class vec2 final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:math.vec2) */ {
 public:
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_math_2fmath_2eproto
