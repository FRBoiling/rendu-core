...
inline ::rendu::proto::core::AppType Options::_internal_apptype() const {
  return static_cast< ::rendu::proto::core::AppType >(apptype_);
}
...
void Options::set_startconfig(ArgT0&& arg0, ArgT... args) {
 ...
 startconfig_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Options::set_allocated_startconfig(std::string* startconfig) {
  ...
  startconfig_.SetAllocated(startconfig, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (startconfig_.IsDefault()) {
...
inline ::rendu::proto::core::DevelopModeType Options::_internal_develop() const {
  return static_cast< ::rendu::proto::core::DevelopModeType >(develop_);
}
