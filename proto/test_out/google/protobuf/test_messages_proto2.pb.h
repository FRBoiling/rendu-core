...
inline std::string* TestAllTypesProto2::_internal_mutable_default_bytes() {
  _has_bits_[0] |= 0x00000020u;
  return default_bytes_.Mutable(::protobuf_test_messages::proto2::TestAllTypesProto2::_i_give_permission_to_break_this_code_default_default_bytes_, GetArenaForAllocation());
}
