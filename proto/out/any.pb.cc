...
static ::_pb::Metadata file_level_metadata_any_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_any_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_any_2eproto = nullptr;
...
const char descriptor_table_protodef_any_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_any_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_any_2eproto = {
    false, false, 196, descriptor_table_protodef_any_2eproto,
    "any.proto",
    &descriptor_table_any_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_any_2eproto::offsets,
    file_level_metadata_any_2eproto, file_level_enum_descriptors_any_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_any_2eproto(&descriptor_table_any_2eproto);
namespace google {
namespace protobuf {
