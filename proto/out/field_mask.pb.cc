...
static ::_pb::Metadata file_level_metadata_field_5fmask_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_field_5fmask_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_field_5fmask_2eproto = nullptr;
...
const char descriptor_table_protodef_field_5fmask_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_field_5fmask_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_field_5fmask_2eproto = {
    false, false, 207, descriptor_table_protodef_field_5fmask_2eproto,
    "field_mask.proto",
    ...
    file_level_metadata_field_5fmask_2eproto, file_level_enum_descriptors_field_5fmask_2eproto,
    file_level_service_descriptors_field_5fmask_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_field_5fmask_2eproto_getter() {
  return &descriptor_table_field_5fmask_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_field_5fmask_2eproto(&descriptor_table_field_5fmask_2eproto);
namespace google {
namespace protobuf {
