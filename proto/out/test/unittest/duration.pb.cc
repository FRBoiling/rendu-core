...
// source: test/unittest/duration.proto

#include "test/unittest/duration.pb.h"
...
static ::_pb::Metadata file_level_metadata_test_2funittest_2fduration_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_test_2funittest_2fduration_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_test_2funittest_2fduration_2eproto = nullptr;

const uint32_t TableStruct_test_2funittest_2fduration_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_test_2funittest_2fduration_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\034test/unittest/duration.proto\022\017google.p"
  "rotobuf\"*\n\010Duration\022\017\n\007seconds\030\001 \001(\003\022\r\n\005"
  "nanos\030\002 \001(\005B\203\001\n\023com.google.protobufB\rDur"
  "ationProtoP\001Z1google.golang.org/protobuf"
  "/types/known/durationpb\370\001\001\242\002\003GPB\252\002\036Googl"
  "e.Protobuf.WellKnownTypesb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_test_2funittest_2fduration_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_2funittest_2fduration_2eproto = {
    false, false, 233, descriptor_table_protodef_test_2funittest_2fduration_2eproto,
    "test/unittest/duration.proto",
    &descriptor_table_test_2funittest_2fduration_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_test_2funittest_2fduration_2eproto::offsets,
    file_level_metadata_test_2funittest_2fduration_2eproto, file_level_enum_descriptors_test_2funittest_2fduration_2eproto,
    file_level_service_descriptors_test_2funittest_2fduration_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_test_2funittest_2fduration_2eproto_getter() {
  return &descriptor_table_test_2funittest_2fduration_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_test_2funittest_2fduration_2eproto(&descriptor_table_test_2funittest_2fduration_2eproto);
namespace google {
namespace protobuf {
...
::PROTOBUF_NAMESPACE_ID::Metadata Duration::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_2funittest_2fduration_2eproto_getter, &descriptor_table_test_2funittest_2fduration_2eproto_once,
      file_level_metadata_test_2funittest_2fduration_2eproto[0]);
}
