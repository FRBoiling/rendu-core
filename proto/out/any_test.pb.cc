...
static ::_pb::Metadata file_level_metadata_any_5ftest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_any_5ftest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_any_5ftest_2eproto = nullptr;

const uint32_t TableStruct_any_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_any_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016any_test.proto\022\021protobuf_unittest\032\tany"
  ".proto\"\207\001\n\007TestAny\022\023\n\013int32_value\030\001 \001(\005\022"
  "\'\n\tany_value\030\002 \001(\0132\024.google.protobuf.Any"
  "\0220\n\022repeated_any_value\030\003 \003(\0132\024.google.pr"
  "otobuf.Any\022\014\n\004text\030\004 \001(\tB\016B\014TestAnyProto"
  "b\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_any_5ftest_2eproto_deps[1] = {
  &::descriptor_table_any_2eproto,
};
static ::_pbi::once_flag descriptor_table_any_5ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_any_5ftest_2eproto = {
    false, false, 208, descriptor_table_protodef_any_5ftest_2eproto,
    "any_test.proto",
    &descriptor_table_any_5ftest_2eproto_once, descriptor_table_any_5ftest_2eproto_deps, 1, 1,
    schemas, file_default_instances, TableStruct_any_5ftest_2eproto::offsets,
    file_level_metadata_any_5ftest_2eproto, file_level_enum_descriptors_any_5ftest_2eproto,
    file_level_service_descriptors_any_5ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_any_5ftest_2eproto_getter() {
  return &descriptor_table_any_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_any_5ftest_2eproto(&descriptor_table_any_5ftest_2eproto);
namespace protobuf_unittest {
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf_unittest.TestAny)
  ...
  if (from._internal_has_any_value()) {
    _internal_mutable_any_value()->::google::protobuf::Any::MergeFrom(from._internal_any_value());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata TestAny::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_any_5ftest_2eproto_getter, &descriptor_table_any_5ftest_2eproto_once,
      file_level_metadata_any_5ftest_2eproto[0]);
}
