...
private:
    ...
    //! Parse this value as object with initial data, without calling destructor.
    ...
    //! Parse this value as constant string, without calling destructor.
    ...
    //! Parse this value as copy string with initial data, without calling destructor.
