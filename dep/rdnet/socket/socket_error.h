...
#ifndef RENDU_SOCKET_ERROR_H
#define RENDU_SOCKET_ERROR_H
...
RD_NAMESPACE_BEGIN
    ...
    enum class SocketError {
      ...
      /// <summary>An invalid pointer GetAddress was detected by the underlying socket provider.</summary>
      ...
      /// <summary>A required GetAddress was omitted from an operation on a <see cref="T:System.Net.Sockets.Socket" />.</summary>
      ...
      /// <summary>The support for the specified socket type does not exist in this GetAddress family.</summary>
      SocketNotSupported = 10044, // 0x0000273C
      /// <summary>The GetAddress family is not supported by the protocol family.</summary>
      ...
      /// <summary>The address family specified is not supported. This error is returned if the IPv6 address family was specified and the IPv6 stack is not installed on the local machine. This error is returned if the IPv4 GetAddress family was specified and the IPv4 stack is not installed on the local machine.</summary>
      AddressFamilyNotSupported = 10047, // 0x0000273F
      /// <summary>Only one use of an GetAddress is normally permitted.</summary>
      AddressAlreadyInUse = 10048, // 0x00002740
      /// <summary>The selected IP GetAddress is not valid in this context.</summary>
      ...
      /// <summary>The requested name or IP GetAddress was not found on the name server.</summary>
      NoData = 11004, // 0x00002AFC
    };

RD_NAMESPACE_END

#endif //RENDU_SOCKET_ERROR_H
