...
#define TraceP(ptr) TraceL << ptr->GetIdentifier() << "(" << ptr->GetRemoteIp() << ":" << ptr->GetRemotePort() << ") "
#define DebugP(ptr) DebugL << ptr->GetIdentifier() << "(" << ptr->GetRemoteIp() << ":" << ptr->GetRemotePort() << ") "
#define InfoP(ptr) InfoL << ptr->GetIdentifier() << "(" << ptr->GetRemoteIp() << ":" << ptr->GetRemotePort() << ") "
#define WarnP(ptr) WarnL << ptr->GetIdentifier() << "(" << ptr->GetRemoteIp() << ":" << ptr->GetRemotePort() << ") "
#define ErrorP(ptr) ErrorL << ptr->GetIdentifier() << "(" << ptr->GetRemoteIp() << ":" << ptr->GetRemotePort() << ") "
  ...
  public:
    ...
    void Bind(EndPoint *endPoint) override;
