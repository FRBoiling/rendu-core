...
namespace detail {
  ...
  public:
    ...
    void return_value(VALUE &&value) noexcept(std::is_nothrow_constructible_v<T, VALUE &&>) {
      ...
      Log_Debug("task_promise return_value");

      m_resultType = result_type::value;
    }

    T &result() & {
      Log_Debug("task_promise result &");
  ...
  public:
    ...
    void return_void() noexcept {
      Log_Debug("void task_promise return_void ");
    ...
    void result() {
      Log_Debug("void task_promise result ");
...
namespace detail {
  ...
  Task<T> task_promise<T>::get_return_object() noexcept {
    Log_Debug("T get_return_object");
    return Task{std::coroutine_handle<task_promise>::from_promise(*this)};
  }

  inline Task<void> task_promise<void>::get_return_object() noexcept {
    Log_Debug("void get_return_object");
    return Task{std::coroutine_handle<task_promise>::from_promise(*this)};
  }
