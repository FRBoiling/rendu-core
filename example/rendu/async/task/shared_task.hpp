...
///////////////////////////////////////////////////////////////////////////////
#ifndef RENDU_ASYNC_SHARED_LAZY_TASK_HPP
#define RENDU_ASYNC_SHARED_LAZY_TASK_HPP
...
ASYNC_NAMESPACE_BEGIN
{
	...
	namespace detail
	{
		...
		public:
			...
			/// waiter->m_coroutine will be resumed when the  completes.
	...
	public:
		...
		/// \brief
		/// Query if the  result is complete.
		///
		/// Awaiting a  that is ready will not block.
		bool is_ready() const noexcept
		{
			return !m_coroutine || m_coroutine.promise().is_ready();
		}
		...
		/// \brief
		/// Returns an awaitable that will await completion of the  without
