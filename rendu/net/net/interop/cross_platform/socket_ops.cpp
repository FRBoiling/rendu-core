...
//    if (sockfd < 0) {
//      RD_CRITICAL("CreateNonblockingOrDie");
//    }
//    SetNoBlocked(sockfd);
//    SetCloExec(sockfd);
//    return sockfd;
//  }
//
//  int Close(const int sfd) {
//    return ::close(sfd);
//  }
//
//  void ShutdownWrite(SOCKET sockfd) {
//    if (shutdown(sockfd, SHUT_WR) < 0) {
//      RD_CRITICAL("shutdown");
//    }
//  }
//
...
//        RD_WARN("inet_pton to ipv6 GetAddress failed:{}", ifr_ip)
//      }
//      addr.sin6_addr = IN6ADDR_ANY_INIT;
//    }
//    if (bind(fd, (struct sockaddr *) &addr, sizeof(addr)) == -1) {
//      RD_WARN("Bind socket failed:{}", interop::GetErrorMsg(true))
//      return -1;
//    }
//    return 0;
//  }
...
//      if (strcmp(ifr_ip, "::")) {
//        RD_WARN("inet_pton to ipv4 GetAddress failed:{}", ifr_ip);
//      }
...
//      RD_WARN("Create socket failed: {}", interop::GetErrorMsg(true));
//      return -1;
//    }
//
...
//      RD_WARN("Listen socket failed: {}", interop::GetErrorMsg(true));
//      close(fd);
//      return -1;
//    }
//
...
//    if (sockfd < 0) {
//      RD_WARN("Create socket failed: {}", host);
//      return -1;
//    }
//
//    SetReuseable(sockfd);
...
//      return sockfd;
//    }
////    if (async && interop::GetError(sockfd) == interop::Error::RD_EAGAIN) {
////      //异步连接成功
////      return sockfd;
////    }
//    RD_WARN("Connect socket to {} {} failed: {} ", host, port, interop::GetErrorMsg(true));
//    close(sockfd);
//    return -1;
//  }
//
...
//    if (-1 == ::connect(fd, (struct sockaddr *) &addr, addr_len) && interop::GetError() != interop::Error::RD_EAFNOSUPPORT) {
//      // mac/ios时返回EAFNOSUPPORT错误
//      RD_WARN("Connect socket AF_UNSPEC failed: {}", interop::GetErrorMsg(true));
//      return -1;
//    }
//    return 0;
//  }
...
//    if (ret == -1) {
//      RD_TRACE("setsockopt IP_ADD_MEMBERSHIP failed: {}", interop::GetErrorMsg(true));
//    }
//#endif
//    clearMulticastAllSocketOption(fd);
//    return ret;
...
//    if (ret == -1) {
//      RD_TRACE("setsockopt IP_DROP_MEMBERSHIP failed: {}", interop::GetErrorMsg(true));
//    }
//#endif
//    clearMulticastAllSocketOption(fd);
//    return ret;
...
//    if (ret == -1) {
//      RD_TRACE("setsockopt IP_ADD_SOURCE_MEMBERSHIP failed: {}", interop::GetErrorMsg(true));
//    }
//#endif
//    clearMulticastAllSocketOption(fd);
//    return ret;
...
//    if (ret == -1) {
//      RD_TRACE("setsockopt IP_DROP_SOURCE_MEMBERSHIP failed: {}", interop::GetErrorMsg(true));
//    }
//#endif
//    clearMulticastAllSocketOption(fd);
//    return ret;
