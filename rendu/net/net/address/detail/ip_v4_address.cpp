...
namespace detail {
  ...
  std::optional<IPv4Address> IPv4Address::Parse(std::string_view string) noexcept {
...

    {
      ...
      partValues[0] = static_cast<uint8_t>(partValue);
    }
    ...
    for (int part = 1; part < 4; ++part) {
      ...
      partValues[part] = static_cast<uint8_t>(partValue);
    }
