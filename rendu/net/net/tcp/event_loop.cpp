...
//      wakeupPipe_(),
//      wakeupChannel_(new Channel(this, 1)),
//      currentActiveChannel_(NULL) {
//
////  RD_TRACE("EventLoop created {} in thread {}", Convert::ToString(this), std::to_string(threadId_));
//  if (t_loopInThisThread) {
////    RD_CRITICAL("Another EventLoop {} exists in this thread {}", t_loopInThisThread, std::to_string(threadId_));
//  } else {
...
//
//EventLoop::~EventLoop() {
////  RD_DEBUG("EventLoop {} of thread {} destructs in thread {} ",
...
////  RD_TRACE("EventLoop {}  start looping",Convert::ToString(this));
//
//  while (!quit_) {
