...
#ifndef RENDU_BASIC_BASIC_UTILS_COMPARABLE_H_
#define RENDU_BASIC_BASIC_UTILS_COMPARABLE_H_
...
struct LessThanComparable2 : B {
  ...
  friend constexpr bool operator>(const U &x, const T &y) { return x < y; }

  friend constexpr bool operator<(const U &x, const T &y) { return x < y; }

  friend constexpr bool operator<=(const U &x, const T &y) { return !static_cast<bool>(x > y); }
...
#define RENDU_OPERATOR_TEMPLATE4(template_name4)          \
...
#define RENDU_OPERATOR_TEMPLATE3(template_name3)       \
...
#define RENDU_OPERATOR_TEMPLATE2(template_name2)    \
...
#define RENDU_OPERATOR_TEMPLATE1(template_name1) \
  template<class T, class B>                     \
  struct is_chained_base<template_name1<T, B>> { \
    typedef operators_detail::true_t value;      \
  };

// RENDU_OPERATOR_TEMPLATE(template_name) defines template_name<> such that it
...
//
#define RENDU_OPERATOR_TEMPLATE(template_name)                                                                            \
  ...
  RENDU_OPERATOR_TEMPLATE2(template_name##2)                                                                              \
  RENDU_OPERATOR_TEMPLATE1(template_name##1)


RENDU_OPERATOR_TEMPLATE(LessThanComparable)
RENDU_OPERATOR_TEMPLATE(EqualityComparable)

#undef RENDU_OPERATOR_TEMPLATE
#undef RENDU_OPERATOR_TEMPLATE4
#undef RENDU_OPERATOR_TEMPLATE3
#undef RENDU_OPERATOR_TEMPLATE2
#undef RENDU_OPERATOR_TEMPLATE1

RD_NAMESPACE_END

#endif//RENDU_BASIC_BASIC_UTILS_COMPARABLE_H_
