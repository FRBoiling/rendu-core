...
#ifndef RENDU_BASIC_BASIC_LOG_LOGGER_WRAPPER_H_
#define RENDU_BASIC_BASIC_LOG_LOGGER_WRAPPER_H_
...
public:
  ...
  static void AddChannel(LoggerChannel *channel);
  static void Clean();
...
#endif//RENDU_BASIC_BASIC_LOG_LOGGER_WRAPPER_H_
