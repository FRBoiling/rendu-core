...
#ifndef RENDU_TASK_TASK_TASK_CANCELLATION_STATE_H_
#define RENDU_TASK_TASK_TASK_CANCELLATION_STATE_H_
...
namespace detail {
  ...
  public:
    ...
    /// CancellationTokenRegistration objects referencing this state.
    ...
    /// Try to register the CancellationTokenRegistration as a callback to be executed
    ...
    bool try_register_callback(CancellationTokenRegistration *registration);
    ...
    void deregister_callback(CancellationTokenRegistration *registration) noexcept;
  ...
  private:
    ...
    // - bits 33-63 - ref-count for cancellation_token/CancellationTokenRegistration instances.
...
#endif//RENDU_TASK_TASK_TASK_CANCELLATION_STATE_H_
