...
#ifndef RENDU_ENUM_DETAIL_H_
#define RENDU_ENUM_DETAIL_H_

#include "enum_define.h"
#include "enum_customize.h"
...
namespace rendu::detail {
  ...
  constexpr bool cmp_less(L lhs, R rhs) noexcept {
    static_assert(std::is_integral_v<L> && std::is_integral_v<R>,
                  "rendu::detail::cmp_less requires integral type.");
  ...
  constexpr I log2(I value) noexcept {
    static_assert(std::is_integral_v<I>, "rendu::detail::log2 requires integral type.");
  ...
  constexpr auto n() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::n requires enum type.");
  ...
  constexpr auto type_name() noexcept {
    ...
    static_assert(std::is_same_v<std::decay_t<decltype(custom)>, customize::customize_t>,
                  "rendu::customize requires customize_t type.");
  ...
  constexpr bool is_valid() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::is_valid requires enum type.");

#if defined(__clang__) && __clang_major__ >= 16
    // https://reviews.llvm.org/D130058, https://reviews.llvm.org/D131307
    constexpr E v = __builtin_bit_cast(E, V);
    [[maybe_unused]] constexpr auto custom = customize::enum_name<E>(v);
    static_assert(std::is_same_v<std::decay_t<decltype(custom)>, customize::customize_t>, "rendu::customize requires customize_t type.");
    if constexpr (std::is_same_v<std::decay_t<decltype(custom)>, customize::customize_t> && custom.index() == 0) {
      constexpr auto name = std::get<string_view>(custom);
      static_assert(!name.empty(), "rendu::customize requires not empty string.");
      return name.size() != 0;
  ...
  constexpr U ualue(std::size_t i) noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::ualue requires enum type.");

    if constexpr (std::is_same_v<U, bool>) { // bool special case
      static_assert(O == 0, "rendu::detail::ualue requires valid offset.");
  ...
  constexpr E value(std::size_t i) noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::value requires enum type.");
  ...
  constexpr int reflected_min() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::reflected_min requires enum type.");
  ...
  constexpr int reflected_max() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::reflected_max requires enum type.");
  ...
  constexpr auto values(std::index_sequence<I...>) noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::values requires enum type.");
  ...
  constexpr bool is_flags_enum() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::is_flags_enum requires enum type.");
  ...
  constexpr auto names(std::index_sequence<I...>) noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::names requires enum type.");
  ...
  constexpr auto entries(std::index_sequence<I...>) noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::entries requires enum type.");
  ...
  constexpr bool is_sparse() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::is_sparse requires enum type.");
  ...
  constexpr U values_ors() noexcept {
    static_assert(is_enum_v<E>, "rendu::detail::values_ors requires enum type.");
  ...
  struct enable_if_enum<true, R> {
    ...
    static_assert(supported<R>::value,
                  "rendu unsupported compiler (https://github.com/Neargye/rendu#compiler-compatibility).");
  };
    ...
    if constexpr ((val) + Page < size) {                                                                                          \
      ...
      if constexpr (CallValue == case_call_t::index) {                                                                            \
        if constexpr (std::is_invocable_r_v<result_t, Lambda, std::integral_constant<std::size_t, val + Page>>) {                 \
          ...
          assert(false && "rendu::detail::constexpr_switch wrong result type.");                                             \
        }                                                                                                                         \
...
#undef RENDU_ENUM_CASE
  ...
  constexpr auto for_each(Lambda &&lambda, std::index_sequence<I...>) {
    static_assert(is_enum_v<E>, "rendu::detail::for_each requires enum type.");
  ...
  constexpr bool all_invocable(std::index_sequence<I...>) {
    static_assert(is_enum_v<E>, "rendu::detail::all_invocable requires enum type.");
