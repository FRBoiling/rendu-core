...
#  define TC_PROTO_API RD_API_EXPORT
#else
#  define TC_PROTO_API RD_API_IMPORT
#endif

#ifdef RENDU_API_EXPORT_DATABASE
#  define TC_DATABASE_API RD_API_EXPORT
#else
#  define TC_DATABASE_API RD_API_IMPORT
#endif

#ifdef RENDU_API_EXPORT_SHARED
#  define TC_SHARED_API RD_API_EXPORT
#else
#  define TC_SHARED_API RD_API_IMPORT
#endif

#ifdef RENDU_API_EXPORT_GAME
#  define TC_GAME_API RD_API_EXPORT
#else
#  define TC_GAME_API RD_API_IMPORT
#endif
