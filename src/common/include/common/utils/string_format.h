...
// ============================================================================
// string_format.h - 字符串格式化工具（基于 fmt 库）
// ============================================================================
...
/**
 * @brief 格式化字符串模板别名，基于 fmt 库的 format_string
 * @tparam Args 格式化参数类型
...
/**
 * @brief 格式化字符串视图别名，基于 fmt 库的 string_view
 * @note 用于表示不可变的格式化字符串
 */
using FormatStringView = fmt::string_view;

/**
 * @brief 格式化参数别名，基于 fmt 库的 format_args
 ...
 */
RC_COMMON_API void StringVFormatToImpl(
