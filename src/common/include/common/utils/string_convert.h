    ...
    namespace Impl::StringConvertImpl
    {
        ...
        struct For<bool, void>
        {
            ...
            /* this is int to match the signature for "proper" integral types */
            {
                ...
                {
                    if ((str == "1") || Utils::StringEqualI(str, "y") || Utils::StringEqualI(str, "on") || Utils::StringEqualI(str, "yes") ||
                        Utils::StringEqualI(str, "true"))
                        return true;
                    if ((str == "0") || Utils::StringEqualI(str, "n") || Utils::StringEqualI(str, "off") || Utils::StringEqualI(str, "no") ||
