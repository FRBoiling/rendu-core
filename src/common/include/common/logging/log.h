...
#define RC_LOG_TRACE(filterType__, message__, ...) \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_TRACE, message__, ## __VA_ARGS__)

#define RC_LOG_DEBUG(filterType__, message__, ...) \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_DEBUG, message__, ## __VA_ARGS__)

#define RC_LOG_INFO(filterType__, message__, ...)  \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_INFO, message__, ## __VA_ARGS__)

#define RC_LOG_WARN(filterType__, message__, ...)  \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_WARN, message__, ## __VA_ARGS__)

#define RC_LOG_ERROR(filterType__, message__, ...) \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_ERROR, message__, ## __VA_ARGS__)

#define RC_LOG_FATAL(filterType__, message__, ...) \
    RC_LOG_MESSAGE_BODY(filterType__, LOG_LEVEL_FATAL, message__, ## __VA_ARGS__)
