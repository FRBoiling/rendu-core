...
#ifndef RENDU_SHARED_DEFINES_H_
#define RENDU_SHARED_DEFINES_H_
...
enum TotemCategory
{
    ...
    RD_TRUESILVER_ROD              = 9,
    RD_ARCANITE_ROD                = 10,
    RD_MINING_PICK_OLD             = 11,
    RD_PHILOSOPHERS_STONE          = 12,
    RD_BLACKSMITH_HAMMER_OLD       = 13,
    RD_ARCLIGHT_SPANNER            = 14,
    RD_GYROMATIC_MA                = 15,
    RD_MASTER_TOTEM                = 21,
    RD_FEL_IRON_ROD                = 41,
    RD_ADAMANTITE_ROD              = 62,
    RD_ETERNIUM_ROD                = 63,
    RD_HOLLOW_QUILL                = 81,
    RD_RUNED_AZURITE_ROD           = 101,
    RD_VIRTUOSO_INKING_SET         = 121,
    RD_DRUMS                       = 141,
    RD_GNOMISH_ARMY_KNIFE          = 161,
    RD_BLACKSMITH_HAMMER           = 162,
    RD_MINING_PICK                 = 165,
    RD_SKINNING_KNIFE              = 166,
    RD_HAMMER_PICK                 = 167,
    RD_BLADED_PICKAXE              = 168,
    RD_FLINT_AND_TINDER            = 169,
    RD_RUNED_COBALT_ROD            = 189,
    RD_RUNED_TITANIUM_ROD          = 190
};
...
namespace Impl
{
    struct RD_SHARED_API CurrentServerProcessHolder
    {
