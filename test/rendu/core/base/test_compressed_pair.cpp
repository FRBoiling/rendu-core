...
TEST(CompressedPair, Size) {
  ...
  static_assert(sizeof(rendu::compressed_pair<int, int>) == sizeof(int[2u]));
  static_assert(sizeof(rendu::compressed_pair<empty_type, int>) == sizeof(int));
  static_assert(sizeof(rendu::compressed_pair<int, empty_type>) == sizeof(int));
  static_assert(sizeof(rendu::compressed_pair<int, empty_type>) < sizeof(local));
  static_assert(sizeof(rendu::compressed_pair<int, empty_type>) < sizeof(std::pair<int, empty_type>));
}

TEST(CompressedPair, ConstructCopyMove) {
  static_assert(!std::is_default_constructible_v<rendu::compressed_pair<non_default_constructible, empty_type>>);
  static_assert(std::is_default_constructible_v<rendu::compressed_pair<move_only_type, empty_type>>);

  static_assert(std::is_copy_constructible_v<rendu::compressed_pair<non_default_constructible, empty_type>>);
  static_assert(!std::is_copy_constructible_v<rendu::compressed_pair<move_only_type, empty_type>>);
  static_assert(std::is_copy_assignable_v<rendu::compressed_pair<non_default_constructible, empty_type>>);
  static_assert(!std::is_copy_assignable_v<rendu::compressed_pair<move_only_type, empty_type>>);

  static_assert(std::is_move_constructible_v<rendu::compressed_pair<move_only_type, empty_type>>);
  static_assert(std::is_move_assignable_v<rendu::compressed_pair<move_only_type, empty_type>>);

  rendu::compressed_pair copyable{non_default_constructible{42}, empty_type{}};
  ...
  rendu::compressed_pair<empty_type, move_only_type> movable{};
...
TEST(CompressedPair, Getters) {
  rendu::compressed_pair pair{3, empty_type{}};
...
TEST(CompressedPair, Swap) {
  rendu::compressed_pair pair{1, 2};
  rendu::compressed_pair other{3, 4};
...
TEST(CompressedPair, Get) {
  ...
  auto [tfirst, tsecond] = rendu::compressed_pair{9, 99};
