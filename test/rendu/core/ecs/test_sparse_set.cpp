...
RD_ASSERT_EQ(set.current(traits_type::construct(traits_type::page_size, 1)), traits_type::to_version(rendu::tombstone));
...
RD_ASSERT_DEATH(set.bump(traits_type::construct(traits_type::to_entity(rendu::entity{3}), traits_type::to_version(rendu::tombstone))), "");
}
...
rendu::sparse_set set;
rendu::entity entities[5u]{rendu::entity{42}, rendu::entity{12}, rendu::entity{9}, rendu::entity{7}, rendu::entity{3}};
...
rendu::sparse_set set;
rendu::entity entities[5u]{rendu::entity{3}, rendu::entity{7}, rendu::entity{9}, rendu::entity{12}, rendu::entity{42}};
...
rendu::sparse_set set;
rendu::entity entities[5u]{rendu::entity{9}, rendu::entity{7}, rendu::entity{3}, rendu::entity{12}, rendu::entity{42}};
...
rendu::sparse_set set{rendu::deletion_policy::in_place};
rendu::entity entities[5u]{rendu::entity{7}, rendu::entity{9}, rendu::entity{3}, rendu::entity{12}, rendu::entity{42}};
...
RD_ASSERT_THROW(set.push(std::begin(entities), std::end(entities)), test::throwing_allocator<rendu::entity>::exception_type);
RD_ASSERT_EQ(set.extent(), 2 * traits_type::page_size);
RD_ASSERT_TRUE(set.contains(rendu::entity{0}));
