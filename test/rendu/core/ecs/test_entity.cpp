...
ASSERT_EQ(traits_type::construct(rendu::to_entity(other), rendu::to_version(entity)), traits_type::combine(rendu::to_integral(other), rendu::to_integral(entity)));
...
ASSERT_EQ(traits_type::next(entity), traits_type::construct(rendu::to_integral(entity), rendu::to_version(entity) + 1u));
...
ASSERT_EQ(traits_type::combine(rendu::null, rendu::to_integral(entity)), (traits_type::construct(rendu::to_entity(null), rendu::to_version(entity))));
...
ASSERT_EQ(traits_type::combine(rendu::to_integral(entity), rendu::tombstone), (traits_type::construct(rendu::to_entity(entity), rendu::to_version(tombstone))));
