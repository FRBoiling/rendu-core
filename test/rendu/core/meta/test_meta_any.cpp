...
TEST_F(MetaAny, SBO) {
  ...
  ASSERT_EQ(any, rendu::meta_any{'c'});
  ASSERT_NE(rendu::meta_any{'h'}, any);
}
...
TEST_F(MetaAny, NoSBO) {
  ...
  ASSERT_NE(any.data(), nullptr);
  ASSERT_EQ(any, rendu::meta_any{instance});
  ASSERT_NE(any, fat_t{});
}
...
TEST_F(MetaAny, Empty) {
  ...
  ASSERT_EQ(any, rendu::meta_any{});
  ASSERT_NE(rendu::meta_any{'c'}, any);
...
TEST_F(MetaAny, SBOInPlaceTypeConstruction) {
  ...
  ASSERT_NE(any.data(), nullptr);
  ASSERT_EQ(any, (rendu::meta_any{std::in_place_type<int>, 42}));
  ASSERT_EQ(any, rendu::meta_any{42});
  ASSERT_NE(rendu::meta_any{3}, any);
}
...
TEST_F(MetaAny, SBOAsRefConstruction) {
  ...
  ASSERT_EQ(any, rendu::forward_as_meta(value));
  ASSERT_NE(any, rendu::forward_as_meta(compare));

  ASSERT_NE(any, rendu::meta_any{42});
  ASSERT_EQ(rendu::meta_any{3}, any);
...
TEST_F(MetaAny, SBOCopyConstruction) {
  ...
  ASSERT_EQ(other, rendu::meta_any{42});
  ASSERT_NE(other, rendu::meta_any{0});
}
...
TEST_F(MetaAny, SBODirectAssignment) {
  ...
  ASSERT_EQ(any.cast<int>(), 42);
  ASSERT_EQ(any, rendu::meta_any{42});
  ASSERT_NE(rendu::meta_any{0}, any);
}
...
TEST_F(MetaAny, SBOTransferConstValue) {
  ...
  ASSERT_TRUE(any.assign(rendu::forward_as_meta(value)));
  ASSERT_EQ(any.cast<int>(), 3);
}
...
TEST_F(MetaAny, NoSBOInPlaceTypeConstruction) {
  ...
  ASSERT_EQ(any.cast<fat_t>(), instance);
  ASSERT_NE(any.data(), nullptr);
  ASSERT_EQ(any, (rendu::meta_any{std::in_place_type<fat_t>, instance}));
  ASSERT_EQ(any, rendu::meta_any{instance});
  ASSERT_NE(rendu::meta_any{fat_t{}}, any);
}
...
TEST_F(MetaAny, NoSBOAsRefConstruction) {
  ...
  ASSERT_TRUE(any);
  ASSERT_FALSE(any.owner());
  ASSERT_EQ(any.type(), rendu::resolve<fat_t>());
  ...
  ASSERT_EQ(any, rendu::forward_as_meta(instance));
...
TEST_F(MetaAny, NoSBOCopyConstruction) {
  ...
  ASSERT_EQ(other, rendu::meta_any{instance});
...
TEST_F(MetaAny, NoSBODirectAssignment) {
  ...
  ASSERT_FALSE(any.try_cast<std::size_t>());
  ASSERT_EQ(any.cast<fat_t>(), instance);
  ASSERT_EQ(any, (rendu::meta_any{fat_t{.1, .2, .3, .4}}));
  ASSERT_NE(any, fat_t{});
}
...
TEST_F(MetaAny, NoSBOTransferConstValue) {
  ...
  ASSERT_TRUE(any.assign(rendu::forward_as_meta(instance)));
  ASSERT_EQ(any.cast<const fat_t &>(), (fat_t{.0, .1, .2, .3}));
  ASSERT_EQ(addr, std::as_const(any).data());
}
...
TEST_F(MetaAny, VoidInPlaceTypeConstruction) {
  ...
  ASSERT_EQ(any, rendu::meta_any{std::in_place_type<void>});
  ASSERT_NE(rendu::meta_any{3}, any);
}
...
TEST_F(MetaAny, VoidCopyConstruction) {
  ...
  ASSERT_TRUE(other);
  ASSERT_EQ(any.type(), rendu::resolve<void>());
  ASSERT_EQ(other, rendu::meta_any{std::in_place_type<void>});
}
...
TEST_F(MetaAny, VoidMoveConstruction) {
  ...
  ASSERT_FALSE(any);
  ASSERT_TRUE(other);
  ASSERT_EQ(other.type(), rendu::resolve<void>());
  ASSERT_EQ(other, rendu::meta_any{std::in_place_type<void>});
}
...
TEST_F(MetaAny, Reset) {
  ...
  ASSERT_FALSE(any);
  ASSERT_EQ(any.type(), rendu::meta_type{});
}
...
TEST_F(MetaAny, SBOWithVoidSwap) {
  ...
  ASSERT_EQ(lhs.type(), rendu::resolve<void>());
  ASSERT_EQ(rhs.cast<char>(), 'c');
}
...
TEST_F(MetaAny, NoSBOWithVoidSwap) {
  ...
  ASSERT_EQ(rhs.type(), rendu::resolve<void>());
  ASSERT_EQ(lhs.cast<fat_t>(), (fat_t{.1, .2, .3, .4}));
}
...
TEST_F(MetaAny, Comparable) {
  ...
  ASSERT_EQ(any, any);
  ASSERT_EQ(any, rendu::meta_any{'c'});
  ASSERT_NE(rendu::meta_any{'a'}, any);
  ASSERT_NE(any, rendu::meta_any{});

  ASSERT_TRUE(any == any);
  ASSERT_TRUE(any == rendu::meta_any{'c'});
  ASSERT_FALSE(rendu::meta_any{'a'} == any);
  ASSERT_TRUE(any != rendu::meta_any{'a'});
  ASSERT_TRUE(rendu::meta_any{} != any);
}
...
TEST_F(MetaAny, NotComparable) {
  ...
  ASSERT_EQ(any, any);
  ASSERT_NE(any, rendu::meta_any{not_comparable_t{}});
  ASSERT_NE(rendu::meta_any{}, any);

  ASSERT_TRUE(any == any);
  ASSERT_FALSE(any == rendu::meta_any{not_comparable_t{}});
  ASSERT_TRUE(rendu::meta_any{} != any);
}
...
TEST_F(MetaAny, CompareVoid) {
  ...
  ASSERT_TRUE(any == any);
  ASSERT_TRUE(any == rendu::meta_any{std::in_place_type<void>});
  ASSERT_FALSE(rendu::meta_any{'a'} == any);
  ASSERT_TRUE(any != rendu::meta_any{'a'});
  ASSERT_TRUE(rendu::meta_any{} != any);
}
...
TEST_F(MetaAny, AllowCast) {
  ...
  ASSERT_EQ(clazz.type(), rendu::resolve<clazz_t>());

  ASSERT_TRUE(clazz.allow_cast<const int &>());
  ASSERT_EQ(clazz.type(), rendu::resolve<int>());
  ...
  ASSERT_EQ(fat.type(), rendu::resolve<fat_t>());
  ...
  ASSERT_EQ(as_cref.type(), rendu::resolve<double>());
}
...
TEST_F(MetaAny, OpaqueAllowCast) {
  ...
  ASSERT_TRUE(clazz.allow_cast(rendu::resolve<clazz_t>()));
  ASSERT_EQ(clazz.type(), rendu::resolve<clazz_t>());

  ASSERT_TRUE(clazz.allow_cast(rendu::resolve<int>()));
  ASSERT_EQ(clazz.type(), rendu::resolve<int>());
  ASSERT_TRUE(clazz.allow_cast(rendu::resolve<int>()));

  ASSERT_TRUE(fat.allow_cast(rendu::resolve<fat_t>()));
  ASSERT_TRUE(fat.allow_cast(rendu::resolve<empty_t>()));
  ASSERT_EQ(fat.type(), rendu::resolve<fat_t>());
  ASSERT_FALSE(fat.allow_cast(rendu::resolve<int>()));

  ASSERT_TRUE(std::as_const(fat).allow_cast(rendu::resolve<fat_t>()));
  ASSERT_TRUE(std::as_const(fat).allow_cast(rendu::resolve<empty_t>()));
  ASSERT_EQ(fat.type(), rendu::resolve<fat_t>());
  ASSERT_FALSE(fat.allow_cast(rendu::resolve<int>()));

  ASSERT_TRUE(arithmetic.allow_cast(rendu::resolve<int>()));
  ASSERT_EQ(arithmetic.type(), rendu::resolve<int>());
  ASSERT_FALSE(arithmetic.allow_cast(rendu::resolve<fat_t>()));

  ASSERT_TRUE(arithmetic.allow_cast(rendu::resolve<double>()));
  ASSERT_EQ(arithmetic.type(), rendu::resolve<double>());
  ASSERT_EQ(arithmetic.cast<double &>(), 42.);

  ASSERT_TRUE(arithmetic.allow_cast(rendu::resolve<float>()));
  ASSERT_EQ(arithmetic.type(), rendu::resolve<float>());
  ASSERT_EQ(arithmetic.cast<float &>(), 42.f);

  ASSERT_TRUE(as_cref.allow_cast(rendu::resolve<int>()));
  ASSERT_EQ(as_cref.type(), rendu::resolve<int>());
  ASSERT_FALSE(as_cref.allow_cast(rendu::resolve<fat_t>()));

  ASSERT_TRUE(as_cref.allow_cast(rendu::resolve<double>()));
  ASSERT_EQ(as_cref.type(), rendu::resolve<double>());
}
...
TEST_F(MetaAny, Convert) {
  ...
  ASSERT_TRUE(as_int);
  ASSERT_EQ(as_int.type(), rendu::resolve<int>());
  ASSERT_EQ(as_int.cast<int>(), 42);

  ASSERT_TRUE(as_int.allow_cast<char>());
  ASSERT_EQ(as_int.type(), rendu::resolve<char>());
...
TEST_F(MetaAny, ArithmeticConversion) {
  ...
  ASSERT_EQ(any.type(), rendu::resolve<char>());
  ASSERT_EQ(any.cast<char>(), 'c');
  ...
  ASSERT_EQ(any.type(), rendu::resolve<float>());
...
TEST_F(MetaAny, EnumConversion) {
  ...
  ASSERT_EQ(any.type(), rendu::resolve<enum_class>());
  ...
  ASSERT_TRUE(any.allow_cast(rendu::resolve<enum_class>()));
  ASSERT_EQ(any.type(), rendu::resolve<enum_class>());
  ASSERT_EQ(any.cast<enum_class>(), enum_class::foo);
}
...
TEST_F(MetaAny, UnmanageableType) {
  ...
  ASSERT_EQ(any.type(), rendu::resolve<unmanageable_t>());
  ASSERT_NE(any.data(), nullptr);
