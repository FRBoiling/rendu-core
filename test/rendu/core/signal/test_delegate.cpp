...
TEST(Delegate, Functionalities) {
  ...
  ASSERT_EQ(ff_del, rendu::delegate < int(int) > {});
  ASSERT_NE(mf_del, rendu::delegate < int(int) > {});
  ASSERT_NE(lf_del, rendu::delegate < int(int) > {});
  ...
  ASSERT_EQ(ff_del, rendu::delegate < int(int) > {});
  ASSERT_EQ(mf_del, rendu::delegate < int(int) > {});
  ASSERT_NE(lf_del, rendu::delegate < int(int) > {});
...
TEST(Delegate, Comparison) {
  ...
  ASSERT_EQ(lhs, rendu::delegate < int(int) > {});
  ...
  ASSERT_EQ(lhs, rendu::delegate < int(int) > {rendu::connect_arg < &delegate_function > });
  ASSERT_TRUE(lhs != rhs);
  ASSERT_FALSE(lhs == rhs);
  ASSERT_NE(lhs, rhs);
  ...
  ASSERT_EQ(rhs, rendu::delegate < int(int) > {rendu::connect_arg < &delegate_function > });
  ASSERT_FALSE(lhs != rhs);
  ASSERT_TRUE(lhs == rhs);
  ASSERT_EQ(lhs, rhs);
  ...
  ASSERT_EQ(lhs, (rendu::delegate < int(int) > {rendu::connect_arg < &curried_by_ref > , value}));
  ASSERT_TRUE(lhs != rhs);
  ASSERT_FALSE(lhs == rhs);
  ASSERT_NE(lhs, rhs);
  ...
  ASSERT_EQ(rhs, (rendu::delegate < int(int) > {rendu::connect_arg < &curried_by_ref > , value}));
  ASSERT_FALSE(lhs != rhs);
  ASSERT_TRUE(lhs == rhs);
  ASSERT_EQ(lhs, rhs);
  ...
  ASSERT_EQ(lhs, (rendu::delegate < int(int) > {rendu::connect_arg < &curried_by_ptr > , &value}));
  ASSERT_TRUE(lhs != rhs);
  ASSERT_FALSE(lhs == rhs);
  ASSERT_NE(lhs, rhs);
  ...
  ASSERT_EQ(rhs, (rendu::delegate < int(int) > {rendu::connect_arg < &curried_by_ptr > , &value}));
  ASSERT_FALSE(lhs != rhs);
  ASSERT_TRUE(lhs == rhs);
  ASSERT_EQ(lhs, rhs);
  ...
  ASSERT_EQ(lhs, (rendu::delegate < int(int) > {rendu::connect_arg < &delegate_functor::operator() > , functor}));
  ASSERT_TRUE(lhs != rhs);
  ASSERT_FALSE(lhs == rhs);
  ASSERT_NE(lhs, rhs);
  ...
  ASSERT_EQ(rhs, (rendu::delegate < int(int) > {rendu::connect_arg < &delegate_functor::operator() > , functor}));
  ...
  ASSERT_EQ(lhs, (rendu::delegate < int(int) > {rendu::connect_arg < &delegate_functor::operator() > , other}));
  ASSERT_EQ(lhs.target(), rhs.target());
  ...
  ASSERT_NE(lhs, (rendu::delegate < int(int) > {[](const void *, int val) { return val + val; }, &functor}));
  ...
  ASSERT_NE(rhs, (rendu::delegate < int(int) > {[](const void *, int val) { return val * val; }, &functor}));
  ASSERT_TRUE(lhs != rhs);
  ASSERT_FALSE(lhs == rhs);
  ASSERT_NE(lhs, rhs);
  ...
  ASSERT_EQ(rhs, (rendu::delegate < int(int) > {}));
  ASSERT_FALSE(lhs != rhs);
  ASSERT_TRUE(lhs == rhs);
  ASSERT_EQ(lhs, rhs);
}
...
TEST(Delegate, ConstInstance) {
  ...
  ASSERT_FALSE(delegate);
  ASSERT_EQ(delegate, rendu::delegate < int(int) > {});
}
